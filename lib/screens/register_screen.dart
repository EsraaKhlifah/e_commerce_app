              ...
              content: AnimatedContainer(
                ...
                child: Row(
                  ...
                  [
                    ...
                    SizedBox(width: 12.5,),
                    const Text(
                      "wait", style: TextStyle(fontWeight: FontWeight.w500),),
                  ],
                ),
              )
          );
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      [
                        ...
                        SizedBox(height: 20,),
                        textFormItem(hintTitle: "Password",
                            controller: passwordController),
                        SizedBox(height: 20,),
                        //مستخدمه علشان ليه لون وضغطه
                        MaterialButton(
                          ...
                          onPressed: () {
                            if (formKey.currentState!.validate() == true) {
                              //عايز استخدم داله الرجستر اللي جوه البلوك
                              BlocProvider.of<AuthCubit>(context).register(
                                //بستخدم الكنترولار علشان اجيب القيم بتاعتي
